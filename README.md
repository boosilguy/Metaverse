...
소통의 어려움 속에서 본인은 사수들께 조심히 궁금한 사항에 대해 문을 두드렸고, 설계 방식과 그들의 결과물을 하나 하나 이해해가고 있었다. 의외로 그들은 마치 기다렸었다는 듯 반겨주었다 (비단, 나 뿐만 아닌 부사수급 주니어 개발자들도 포함). 물론, 이 기간은 그리 오래가지 못하였고 1차년도 평가를 위해, 각 Module 개발에 집중하여야 했다. 그렇게, 부평역 1차년도 평가 Sample 앱을 완성시키기 위해, 사수와 함께 Navigation Module, Speech Module, Setting, 그리고 샘플앱을 개발해 나아갔다. 

22년 1월, 8월에 거쳐, 부장급과 미들라인들의 대거 퇴사로 인하여, 해당 프로젝트는 사실상 혼자 맡고 있는 상황이다. 혼자서 모든 모듈을 꿰고 있어야하고, 배포와 유지보수도 마찬가지였다. 그러다보니, 그들의 흔적을 통해 몇 가지를 배울 수 있었다 (*해당 프로젝트 구조를 전재*).
...
- 기타
    - 내장 Debug Logging : 최종 빌드의 성능을 컨트롤하기 위해, 별도 Debug 클래스를 구성하여, LogLevel (Setting)을 컨트롤.
...
쉽게 말해, 인정받을 수 있어 좋았다. 어렸을 때 사회, 도덕 과목 (맞나?)에서 배우던 직업의 의미를 살펴보면, 생계 유지의 경제적 의미, **구성원으로서의 사회적인 의미**, 그리고 **자부심을 갖고 발전한다는 심리적 의미** 등이 있다고 배웠다. 나는 실무 2년도 안넘기고 모든 것을 느낀게 아닐까? 첫 이력서에서도 내 강점은 **책임감**이라고 어필했던 기억이 어렴풋 기억나는데, 내가 거짓으로 적진 않았구나 싶다. 극한의 상황 속에서도 책임감을 갖고 맡은 일을 행하면, 사회속에서 인정을 받고, 내면적으로도 성장한다는 것을 많이 느낄 수 있었다 (이젠... 충분히 단도리하였으니, 이 곳을 떠나보려 합니다).
</details>
